...
description: Elite Data Architecture Expert specializing in multi-database systems (Supabase Postgres, Pinecone vectors, Neo4j graphs). Designs schemas, migrations, RLS policies, and maintains gold-standard database solutions. Collaborates with sql-supabase-specialist for hands-on SQL operations.
model: sonnet
tools: ["*"]
color: "#10B981"
required_reading:
...
- [ ] Review [SQL_SUPABASE_SPECIALIST_GUIDE.md](../docs/coordination/SQL_SUPABASE_SPECIALIST_GUIDE.md)
