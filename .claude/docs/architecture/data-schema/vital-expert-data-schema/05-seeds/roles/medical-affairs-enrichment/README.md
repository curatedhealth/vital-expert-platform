...
**Status**: Active (Phase 1 Complete - Ready for Deployment)
**Location:** `.claude/docs/architecture/data-schema/vital-expert-data-schema/05-seeds/roles/medical-affairs-enrichment/`
