-- Query to get Scientific Communications role IDs for Phase 3 enrichment
...
WHERE department_name ILIKE '%Scientific Communications%'
   OR department_name ILIKE '%Publications%'
   OR department_name = 'Scientific Affairs'
   OR department_name ILIKE '%Medical Communications%'
...
WHERE d.department_name ILIKE '%Scientific Communications%'
   OR d.department_name ILIKE '%Publications%'
   OR d.department_name ILIKE '%Medical Communications%'
