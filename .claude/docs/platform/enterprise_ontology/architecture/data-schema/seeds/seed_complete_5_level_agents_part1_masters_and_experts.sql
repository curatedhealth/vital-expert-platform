...
-- Part 1: Master Agents (Level 1) + Expert Agents (Level 2)
-- =====================================================
-- This seed file creates:
-- - 5 Master Agents (Level 1)
-- - 35 Expert Agents (Level 2) from Medical Affairs JSON
-- 
...
-- - tenant_id
-- 
-- This ensures perfect Graph-RAG connectivity
-- =====================================================
...
BEGIN
    ...
    INSERT INTO agents (
        ...
        agent_level, can_spawn_specialists, can_spawn_workers, max_spawned_agents
    ) VALUES (
