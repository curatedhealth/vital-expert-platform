-- ============================================================================
-- Migration: Medical Affairs Rich Prompts Library
-- Date: 2025-12-02
...
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
VALUES
(
...
(
  ...
  'user', 'education', 'expert',
  ARRAY['CME', 'medical-education', 'curriculum', 'needs-assessment', 'outcomes'],
  ARRAY['vital-system']::uuid[]
);

-- ============================================================================
-- PART 2: L3 SPECIALIST RICH PROMPTS (Selected Examples)
-- ============================================================================

-- 2.1 Medical Writer - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
VALUES
(
...
(
  ...
  'user', 'clinical', 'intermediate',
  ARRAY['investigator-brochure', 'IB-update', 'safety-data', 'clinical-development'],
  ARRAY['vital-system']::uuid[]
);

-- 2.2 Medical Science Liaison Advisor - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
VALUES
(
...
-- 2.3 Safety Signal Evaluator - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
VALUES
(
...
-- ============================================================================
-- PART 3: LINK STARTERS TO RICH PROMPTS
-- ============================================================================

-- Update agent_prompt_starters with prompt_id links
UPDATE agent_prompt_starters aps
SET prompt_id = p.id
FROM prompts p
WHERE p.name = aps.text || ' - Starter'
OR p.name LIKE '%' || LEFT(aps.text, 50) || '%';

-- Create view for verification
...
-- Check Medical Affairs prompt coverage
SELECT
  level_number,
  level_name,
  COUNT(*) as agents,
