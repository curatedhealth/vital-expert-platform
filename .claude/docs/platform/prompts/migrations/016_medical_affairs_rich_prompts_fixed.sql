-- ============================================================================
-- Migration: Medical Affairs Rich Prompts Library (FIXED)
-- Date: 2025-12-02
-- Purpose: Create detailed prompts linked to agent_prompt_starters
-- Fix: Use actual tenant UUID instead of text 'vital-system'
-- ============================================================================
...
-- 1.3 Medical Writer - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
SELECT
...
-- 1.4 Medical Science Liaison Advisor - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
SELECT
...
-- 1.5 Safety Signal Evaluator - Rich Prompts
INSERT INTO prompts (name, content, role_type, category, complexity, tags, allowed_tenants)
SELECT
