-- ============================================================================
-- Migration: Medical Affairs Rich Prompts Library (V2 - FIXED)
-- Date: 2025-12-02
...
INSERT INTO prompts (prompt_code, name, content, role_type, category, complexity, tags, allowed_tenants)
SELECT
  'MA-BVE-001',
