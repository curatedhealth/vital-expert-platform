...
DO $$ BEGIN RAISE NOTICE 'Starting simple schema fixes...'; END $$;

-- ============================================================================
-- Add category column to tools table (if it doesn't exist)
-- ============================================================================
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        DO $$ BEGIN RAISE NOTICE '✅ Category column added to tools table'; END $$;
    ELSE
        DO $$ BEGIN RAISE NOTICE 'ℹ️  Category column already exists in tools table'; END $$;
    END IF;
END $$;

-- ============================================================================
-- Add is_active column to tools table (if it doesn't exist)
-- ============================================================================

DO $$ BEGIN RAISE NOTICE 'Adding is_active column to tools table...'; END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        DO $$ BEGIN RAISE NOTICE '✅ is_active column added to tools table'; END $$;
    ELSE
        DO $$ BEGIN RAISE NOTICE 'ℹ️  is_active column already exists in tools table'; END $$;
    END IF;
END $$;

-- ============================================================================
-- Add tool_type column to tools table (if it doesn't exist)
-- ============================================================================

DO $$ BEGIN RAISE NOTICE 'Adding tool_type column to tools table...'; END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        DO $$ BEGIN RAISE NOTICE '✅ tool_type column added to tools table'; END $$;
    ELSE
        DO $$ BEGIN RAISE NOTICE 'ℹ️  tool_type column already exists in tools table'; END $$;
    END IF;
END $$;
...
DO $$ BEGIN RAISE NOTICE '✅ Simple schema fixes completed successfully!'; END $$;
DO $$ BEGIN RAISE NOTICE '============================================'; END $$;
