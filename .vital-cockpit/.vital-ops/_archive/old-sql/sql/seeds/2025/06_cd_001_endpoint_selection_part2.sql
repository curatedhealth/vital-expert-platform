...
CROSS JOIN (
  VALUES
    ...
    ('TSK-CD-001-P2-01', 'AGT-REGULATORY-INTELLIGENCE', 'PRIMARY_EXECUTOR', 1, true, 3, 'EXPONENTIAL_BACKOFF', false, 'P05_REGAFF', 'AFTER_EXECUTION', 'ESCALATE_TO_HUMAN', '{"role": "Lead precedent research", "focus": "FDA approvals analysis"}'::jsonb),
    ...
    ('TSK-CD-001-P3-01', 'AGT-BIOSTATISTICS', 'PRIMARY_EXECUTOR', 1, true, 2, 'EXPONENTIAL_BACKOFF', false, 'P09_DATASCIENCE', 'AFTER_EXECUTION', 'ESCALATE_TO_HUMAN', '{"role": "Digital biomarker assessment", "focus": "Technical feasibility"}'::jsonb),
    ...
    ('TSK-CD-001-P4-03', 'AGT-CLINICAL-REPORT-WRITER', 'PRIMARY_EXECUTOR', 1, true, 2, 'EXPONENTIAL_BACKOFF', false, 'P05_REGAFF', 'AFTER_EXECUTION', 'ESCALATE_TO_HUMAN', '{"role": "Draft regulatory justification", "focus": "FDA submission quality"}'::jsonb),
    ...
    ('TSK-CD-001-P5-02', 'AGT-CLINICAL-ENDPOINT', 'PRIMARY_EXECUTOR', 1, true, 3, 'EXPONENTIAL_BACKOFF', false, 'P12_CLINICAL', 'AFTER_EXECUTION', 'ESCALATE_TO_HUMAN', '{"role": "Validation planning", "focus": "Psychometric strategy"}'::jsonb),
    ...
    ('TSK-CD-001-P5-03', 'AGT-REGULATORY-COMPLIANCE', 'PRIMARY_EXECUTOR', 1, true, 3, 'EXPONENTIAL_BACKOFF', false, 'P05_REGAFF', 'AFTER_EXECUTION', 'ESCALATE_TO_HUMAN', '{"role": "Risk assessment lead", "focus": "FDA concerns mitigation"}'::jsonb),
...
CROSS JOIN (
  VALUES
    ...
    ('TSK-CD-001-P1-01', 'P05_REGAFF', 'PROVIDE_INPUT', false, 'PARALLEL', 'email', '{"role": "Regulatory input", "review_focus": "FDA perspective"}'::jsonb),
    ...
    ('TSK-CD-001-P1-02', 'P08_HEOR', 'PROVIDE_INPUT', false, 'PARALLEL', 'email', '{"role": "HEOR perspective", "review_focus": "Payer value"}'::jsonb),
    
    -- Task 3: Research Regulatory Precedent (P2-01)
    ('TSK-CD-001-P2-01', 'P05_REGAFF', 'APPROVE', true, 'AFTER_AGENT_RUNS', 'email', '{"role": "Regulatory approval", "review_focus": "Precedent accuracy and completeness"}'::jsonb),
    ...
    -- Task 5: Assess Digital Biomarker Feasibility (P3-01)
    ('TSK-CD-001-P3-01', 'P09_DATASCIENCE', 'APPROVE', true, 'AFTER_AGENT_RUNS', 'email', '{"role": "Data science approval", "review_focus": "Technical feasibility and validation"}'::jsonb),
    ('TSK-CD-001-P3-01', 'P01_CMO', 'REVIEW', false, 'AFTER_AGENT_RUNS', 'email', '{"role": "Clinical review", "review_focus": "Clinical relevance"}'::jsonb),
    ('TSK-CD-001-P3-01', 'P05_REGAFF', 'REVIEW', false, 'PARALLEL', 'email', '{"role": "Regulatory review", "review_focus": "FDA acceptance likelihood"}'::jsonb),
    ...
    ('TSK-CD-001-P3-02', 'P08_HEOR', 'REVIEW', false, 'PARALLEL', 'email', '{"role": "HEOR review", "review_focus": "Payer perspective and comparator relevance"}'::jsonb),
    ...
    ('TSK-CD-001-P4-01', 'P05_REGAFF', 'REVIEW', false, 'PARALLEL', 'email', '{"role": "Regulatory review", "review_focus": "FDA acceptability scoring"}'::jsonb),
    ...
    -- Task 9: Draft Endpoint Justification (P4-03)
    ('TSK-CD-001-P4-03', 'P05_REGAFF', 'APPROVE', true, 'AFTER_AGENT_RUNS', 'email', '{"role": "Regulatory approval", "review_focus": "FDA submission readiness"}'::jsonb),
    ...
    ('TSK-CD-001-P4-03', 'P11_MEDICAL', 'PROVIDE_INPUT', false, 'PARALLEL', 'email', '{"role": "Medical writing", "review_focus": "Document quality and clarity"}'::jsonb),
    ...
    ('TSK-CD-001-P5-01', 'P09_DATASCIENCE', 'PROVIDE_INPUT', false, 'PARALLEL', 'email', '{"role": "Data collection input", "review_focus": "Digital integration"}'::jsonb),
    
    -- Task 11: Plan Validation Strategy (P5-02)
    ('TSK-CD-001-P5-02', 'P12_CLINICAL', 'APPROVE', true, 'AFTER_AGENT_RUNS', 'email', '{"role": "Clinical research approval", "review_focus": "Validation methodology"}'::jsonb),
    ('TSK-CD-001-P5-02', 'P05_REGAFF', 'REVIEW', false, 'PARALLEL', 'email', '{"role": "Regulatory review", "review_focus": "FDA validation expectations"}'::jsonb),
    ...
    -- Task 12: Assess Risk & Mitigation (P5-03)
    ('TSK-CD-001-P5-03', 'P05_REGAFF', 'APPROVE', true, 'AFTER_AGENT_RUNS', 'email', '{"role": "Regulatory risk approval", "review_focus": "Mitigation completeness"}'::jsonb),
    ...
    ('TSK-CD-001-P5-04', 'P05_REGAFF', 'REVIEW', false, 'AFTER_AGENT_RUNS', 'email', '{"role": "Regulatory final review", "review_focus": "Regulatory strategy coherence"}'::jsonb),
    ...
    ('TSK-CD-001-P5-04', 'P11_MEDICAL', 'PROVIDE_INPUT', false, 'PARALLEL', 'email', '{"role": "Final document review", "review_focus": "Quality and completeness"}'::jsonb)
) AS persona_data(
  task_code,
  persona_code,
  responsibility,
...
CROSS JOIN (
  VALUES
    ...
    ('TSK-CD-001-P1-01', 'TOOL-PUBMED', '{"purpose": "Clinical literature search and FDA guidance review", "search_scope": "Disease epidemiology, burden, and DTx guidance"}'::jsonb),
    
    -- Task 2: Patient Outcomes (PRO database, patient forums)
    ('TSK-CD-001-P1-02', 'TOOL-PROQOLID', '{"purpose": "PRO instrument search", "focus": "Patient-reported outcomes"}'::jsonb),
    
    -- Task 3: Regulatory Precedent (FDA database, regulatory intelligence)
    ('TSK-CD-001-P2-01', 'TOOL-PUBMED', '{"purpose": "FDA precedent analysis and regulatory literature", "focus": "Prior DTx approvals and endpoint precedent"}'::jsonb),
    ('TSK-CD-001-P2-01', 'TOOL-CLINTRIALS', '{"purpose": "Regulatory intelligence", "focus": "FDA decisions and feedback"}'::jsonb),
    
    -- Task 4: PRO Evaluation (PRO database, validation tools)
    ('TSK-CD-001-P2-02', 'TOOL-PROQOLID', '{"purpose": "PRO instrument evaluation", "focus": "Psychometric properties"}'::jsonb),
    ('TSK-CD-001-P2-02', 'TOOL-PUBMED', '{"purpose": "PRO validation literature", "focus": "Validation studies"}'::jsonb),
    
    -- Task 5: Digital Biomarkers (wearable data, digital health platforms)
    ('TSK-CD-001-P3-01', 'TOOL-R-STATS', '{"purpose": "Digital biomarker analysis", "focus": "Sensor data capabilities"}'::jsonb),
    ('TSK-CD-001-P3-01', 'TOOL-PUBMED', '{"purpose": "Digital biomarker literature", "focus": "Validation evidence"}'::jsonb),
    
    -- Task 6: Comparator Analysis (market research, competitive intelligence)
    ('TSK-CD-001-P3-02', 'TOOL-PUBMED', '{"purpose": "Comparator research", "focus": "Standard of care and competitors"}'::jsonb),
    
    -- Task 7: Endpoint Scoring (decision matrix tools)
    ('TSK-CD-001-P4-01', 'TOOL-R-STATS', '{"purpose": "Multi-criteria analysis", "focus": "Endpoint scoring and ranking"}'::jsonb),
    
    -- Task 8: Power Analysis (statistical software)
    ('TSK-CD-001-P4-02', 'TOOL-R-STATS', '{"purpose": "Power calculations", "focus": "Sample size estimation"}'::jsonb),
    
    -- Task 9: Endpoint Justification (medical writing tools)
    ('TSK-CD-001-P4-03', 'TOOL-PUBMED', '{"purpose": "Regulatory templates", "focus": "FDA submission format"}'::jsonb),
    
    -- Task 10: Measurement Schedule (clinical trial design tools)
    ('TSK-CD-001-P5-01', 'TOOL-R-STATS', '{"purpose": "Schedule optimization", "focus": "Visit timing and burden analysis"}'::jsonb),
    
    -- Task 11: Validation Strategy (validation frameworks)
    ('TSK-CD-001-P5-02', 'TOOL-PROQOLID', '{"purpose": "Validation planning", "focus": "Psychometric validation methodology"}'::jsonb),
    ('TSK-CD-001-P5-02', 'TOOL-PUBMED', '{"purpose": "FDA validation guidance", "focus": "Regulatory requirements"}'::jsonb),
    
    -- Task 12: Risk Assessment (risk management tools)
    ('TSK-CD-001-P5-03', 'TOOL-PUBMED', '{"purpose": "Regulatory risk assessment", "focus": "FDA concerns identification"}'::jsonb),
    
    -- Task 13: Final Recommendation (document compilation)
    ('TSK-CD-001-P5-04', 'TOOL-R-STATS', '{"purpose": "Report generation", "focus": "Data visualization and synthesis"}'::jsonb)
...
CROSS JOIN (
  VALUES
    ...
    ('TSK-CD-001-P1-01', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What are FDA guidance documents for digital therapeutics and clinical endpoints?', true, '{"purpose": "FDA regulatory guidance", "focus": "DTx endpoint selection", "max_results": 10}'::jsonb),
    ('TSK-CD-001-P1-01', 'RAG-ISPOR-PRO-2011', 'What is the clinical burden and epidemiology of [indication]?', true, '{"purpose": "Clinical context", "focus": "Disease burden", "max_results": 20}'::jsonb),
    
    -- Task 2: Patient Outcomes
    ('TSK-CD-001-P1-02', 'RAG-PROMIS', 'What patient-reported outcomes are relevant for [indication]?', true, '{"purpose": "PRO identification", "focus": "Patient-centered outcomes", "max_results": 15}'::jsonb),
    ('TSK-CD-001-P1-02', 'RAG-ISPOR-PRO-2011', 'What outcomes matter most to patients with [indication]?', true, '{"purpose": "Patient priorities", "focus": "Quality of life", "max_results": 15}'::jsonb),
    
    -- Task 3: Regulatory Precedent
    ('TSK-CD-001-P2-01', 'RAG-FDA-DRUGS-DB', 'What DTx products have been approved for [indication] and what endpoints were used?', true, '{"purpose": "Regulatory precedent", "focus": "FDA-accepted endpoints", "max_results": 20}'::jsonb),
    ('TSK-CD-001-P2-01', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What are FDA requirements for clinical endpoints in [indication]?', true, '{"purpose": "FDA requirements", "focus": "Endpoint standards", "max_results": 10}'::jsonb),
    
    -- Task 4: PRO Evaluation
    ('TSK-CD-001-P2-02', 'RAG-PROMIS', 'What are validated PRO instruments for [indication] and their psychometric properties?', true, '{"purpose": "PRO validation evidence", "focus": "Psychometric properties", "max_results": 25}'::jsonb),
    ('TSK-CD-001-P2-02', 'RAG-ISPOR-PRO-2011', 'What is the validation evidence for PRO instruments in [indication]?', true, '{"purpose": "PRO validation studies", "focus": "Responsiveness and MCID", "max_results": 20}'::jsonb),
    
    -- Task 5: Digital Biomarkers
    ('TSK-CD-001-P3-01', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What digital biomarkers exist for [indication] and what is their validation status?', true, '{"purpose": "Digital biomarker landscape", "focus": "Validation evidence", "max_results": 20}'::jsonb),
    ('TSK-CD-001-P3-01', 'RAG-FDA-DRUGS-DB', 'Has FDA accepted any digital biomarkers for [indication]?', true, '{"purpose": "FDA precedent", "focus": "Digital measure acceptance", "max_results": 10}'::jsonb),
    
    -- Task 6: Comparator Analysis
    ('TSK-CD-001-P3-02', 'RAG-ISPOR-PRO-2011', 'What are standard of care treatments and payer outcomes for [indication]?', true, '{"purpose": "Comparator and payer analysis", "focus": "Current treatment standards and reimbursement criteria", "max_results": 15}'::jsonb),
    
    -- Task 7: Endpoint Scoring
    ('TSK-CD-001-P4-01', 'RAG-FDA-DRUGS-DB', 'Which endpoints have the strongest FDA precedent for DTx?', true, '{"purpose": "Regulatory scoring", "focus": "FDA acceptance history", "max_results": 15}'::jsonb),
    ('TSK-CD-001-P4-01', 'RAG-PROMIS', 'What are the psychometric properties of candidate endpoints?', true, '{"purpose": "Psychometric scoring", "focus": "Validation strength", "max_results": 20}'::jsonb),
    
    -- Task 8: Power Analysis
    ('TSK-CD-001-P4-02', 'RAG-ISPOR-PRO-2011', 'What are typical effect sizes and variability for [endpoint] in [indication]?', true, '{"purpose": "Power calculation inputs", "focus": "Effect sizes and SDs", "max_results": 20}'::jsonb),
    
    -- Task 9: Endpoint Justification
    ('TSK-CD-001-P4-03', 'RAG-FDA-DRUGS-DB', 'What was the FDA rationale for accepting similar endpoints?', true, '{"purpose": "Regulatory justification", "focus": "FDA precedent reasoning", "max_results": 15}'::jsonb),
    ('TSK-CD-001-P4-03', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What are FDA expectations for endpoint justification?', true, '{"purpose": "FDA requirements", "focus": "Justification standards", "max_results": 10}'::jsonb),
    
    -- Task 10: Measurement Schedule
    ('TSK-CD-001-P5-01', 'RAG-ISPOR-PRO-2011', 'What measurement schedules are used in [indication] trials?', true, '{"purpose": "Schedule precedent", "focus": "Assessment timing", "max_results": 15}'::jsonb),
    
    -- Task 11: Validation Strategy
    ('TSK-CD-001-P5-02', 'RAG-PROMIS', 'What validation methodology is recommended for [endpoint type]?', true, '{"purpose": "Validation guidance", "focus": "Psychometric methods", "max_results": 10}'::jsonb),
    ('TSK-CD-001-P5-02', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What are FDA validation requirements for novel endpoints?', true, '{"purpose": "FDA validation standards", "focus": "Regulatory requirements", "max_results": 10}'::jsonb),
    
    -- Task 12: Risk Assessment
    ('TSK-CD-001-P5-03', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What are common FDA concerns for DTx endpoints?', true, '{"purpose": "Risk identification", "focus": "FDA objections", "max_results": 10}'::jsonb),
    ('TSK-CD-001-P5-03', 'RAG-FDA-DRUGS-DB', 'What FDA questions and concerns were raised for similar DTx products?', true, '{"purpose": "Precedent concerns", "focus": "FDA feedback", "max_results": 15}'::jsonb),
    
    -- Task 13: Final Recommendation
    ('TSK-CD-001-P5-04', 'RAG-FDA-DIGITAL-HEALTH-2022', 'What is the complete FDA framework for endpoint selection?', true, '{"purpose": "Comprehensive guidance", "focus": "End-to-end requirements", "max_results": 10}'::jsonb)
