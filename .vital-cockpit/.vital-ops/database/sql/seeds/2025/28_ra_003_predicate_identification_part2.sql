-- =====================================================================================
-- UC_RA_003: Predicate Device Identification - Part 2: Task Assignments
-- =====================================================================================
...
CROSS JOIN (VALUES
  ('TSK-RA-003-02', 'RAG-FDA-GUIDANCE', '510(k) database search strategy, product code classification, intended use search',
   '{"max_results": 5, "similarity_threshold": 0.8}'::jsonb, '{"purpose": "Search methodology"}'::jsonb),
  ('TSK-RA-003-04', 'RAG-FDA-GUIDANCE', 'Substantial equivalence criteria, intended use comparison, technological characteristics',
   '{"max_results": 5, "similarity_threshold": 0.8}'::jsonb, '{"purpose": "Equivalence criteria"}'::jsonb)
...
SELECT 'UC_RA_003 Part 2 Seeded' as status;
