-- Complete VITAL Expert Cloud Migration
-- This migration creates the complete database schema for cloud deployment
...
-- Note: Vector extension will be enabled separately in Supabase dashboard
...
-- Document embeddings for RAG (without vector extension for now)
