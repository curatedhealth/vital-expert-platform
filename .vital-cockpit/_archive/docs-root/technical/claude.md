...
**🔗 For complete documentation structure**, see [`.vital-docs/INDEX.md`](../../.vital-docs/INDEX.md)

**Key Documentation Locations**:
- **Agent Coordination**: [`.vital-docs/agents/AGENT_COORDINATION_GUIDE.md`](../../.vital-docs/agents/AGENT_COORDINATION_GUIDE.md)
- **Database Schema**: [`.vital-docs/vital-expert-docs/10-data-schema/GOLD_STANDARD_SCHEMA.md`](../../.vital-docs/vital-expert-docs/10-data-schema/GOLD_STANDARD_SCHEMA.md)
- **Quick Start**: [`.vital-docs/vital-expert-docs/00-overview/README_START_HERE.md`](../../.vital-docs/vital-expert-docs/00-overview/README_START_HERE.md)
