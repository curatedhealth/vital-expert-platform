...
// Function to process Medical Affairs agents with unique names
function processMedicalAffairsAgents(jsonData, existingNames, existingDisplayNames) {
...
// Function to process Market Access agents with unique names
function processMarketAccessAgents(jsonData, existingNames, existingDisplayNames) {
...
// Function to process Marketing agents with unique names
function processMarketingAgents(jsonData, existingNames, existingDisplayNames) {
...
async function importAgentsWithUniqueNames() {
  try {
    console.log('🚀 AGENT IMPORT WITH UNIQUE NAME GENERATION');
    console.log('======================================================================\n');
    ...
    // Step 2: Load and process Medical Affairs agents
    console.log('📋 Step 2: Processing Medical Affairs agents...');
    ...
    const medicalAffairsAgents = processMedicalAffairsAgents(medicalAffairsData, existingNames, existingDisplayNames);
    console.log(`✅ Processed ${medicalAffairsAgents.length} Medical Affairs agents\n`);
    
    // Step 3: Load and process Market Access agents
    console.log('📋 Step 3: Processing Market Access agents...');
    ...
    const marketAccessAgents = processMarketAccessAgents(marketAccessData, existingNames, existingDisplayNames);
    console.log(`✅ Processed ${marketAccessAgents.length} Market Access agents\n`);
    
    // Step 4: Load and process Marketing agents
    console.log('📋 Step 4: Processing Marketing agents...');
    ...
    const marketingAgents = processMarketingAgents(marketingData, existingNames, existingDisplayNames);
    console.log(`✅ Processed ${marketingAgents.length} Marketing agents\n`);
    
    // Step 5: Combine all agents
    ...
    // Step 6: Upload all agents to Supabase with robust error handling
    console.log('📋 Step 6: Uploading agents to Supabase Cloud...');
    ...
    // Step 8: Show sample of uploaded agents
    console.log('📋 Step 8: Sample of uploaded agents:');
    ...
    console.log('\n🎉 AGENT IMPORT WITH UNIQUE NAMES COMPLETE!');
    console.log('======================================================================');
