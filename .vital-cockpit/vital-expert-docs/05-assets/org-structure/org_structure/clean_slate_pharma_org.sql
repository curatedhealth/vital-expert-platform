-- =====================================================================
-- CLEAN SLATE: REMOVE ALL PHARMA FUNCTIONS AND DEPARTMENTS
-- Deletes all functions and departments for Pharmaceuticals tenant
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '✅ Pharmaceuticals tenant functions and departments are now clean';
