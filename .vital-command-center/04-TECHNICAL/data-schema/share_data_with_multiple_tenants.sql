-- ============================================================================
-- Share VITAL Platform Data with Multiple Tenants
-- ============================================================================
-- Shares agents, knowledge_domains, and tools with:
-- - Pharmaceuticals
...
BEGIN
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '🔄 SHARING DATA WITH MULTIPLE TENANTS';
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  ...
  LOOP
    ...
    -- First, delete any existing agents for this tenant to avoid duplicates
    ...
    -- Delete existing knowledge domains for this tenant
    ...
    -- Delete existing tools for this tenant
