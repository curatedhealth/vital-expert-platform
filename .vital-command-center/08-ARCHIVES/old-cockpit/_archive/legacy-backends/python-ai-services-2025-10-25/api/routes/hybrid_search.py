...
# Exception handlers removed - APIRouter doesn't support exception_handler decorator
# Exception handlers should be added to the FastAPI app instance in main.py instead
# Example in main.py:
