-- =====================================================================
-- MERGE DUPLICATE ROLES (SAFE VERSION)
-- Option A: Merge duplicates
-- IMPORTANT: Only deletes roles WITHOUT personas assigned
-- =====================================================================
...
SELECT 
    ...
    COUNT(CASE WHEN keep_priority > 1 AND persona_count = 0 THEN 1 END) as roles_to_delete_no_personas,
