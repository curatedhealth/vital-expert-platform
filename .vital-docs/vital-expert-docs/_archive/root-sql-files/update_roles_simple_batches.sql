-- =====================================================================
-- SIMPLIFIED: Update Roles in Small Batches
-- Run each batch separately if needed
-- =====================================================================

-- BATCH 1: Field Medical (5 roles)
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Field Medical' LIMIT 1),
    updated_at = NOW()
...
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Medical Information' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
...
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Medical Communications' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
...
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Medical Publications' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
...
-- BATCH 5: Regulatory Submissions (4 roles)
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Regulatory Submissions' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
  AND name IN ('Medical Writer Regulatory', 'Medical Compliance Manager', 'Medical Quality Manager', 'Head of Medical Excellence');

-- BATCH 6: Medical Strategy & Operations (2 roles)
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Medical Strategy & Operations' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
...
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Leadership' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
...
UPDATE public.org_roles 
SET department_id = (SELECT id FROM public.org_departments WHERE name = 'Clinical Operations Support' LIMIT 1),
    updated_at = NOW()
WHERE deleted_at IS NULL
  AND department_id IS NULL
  AND tenant_id IN (SELECT id FROM public.tenants WHERE slug IN ('pharmaceuticals', 'pharma'))
