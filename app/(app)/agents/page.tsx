...
function AgentsPageContent() {
  ...
  const { searchQuery, setSearchQuery, filters, setFilters, setViewMode } = useAgentsFilter();
    ...
    try {
      ...
      if (!agent.is_user_copy) {
        ...
        const chatAgent: Agent = {
          ...
          organizationalRole: userCopy.organizational_role || userCopy.role || undefined,
