        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <label htmlFor="panel-name" className="text-sm font-medium mb-2 block">Panel Name</label>
                <Input
                  id="panel-name"
                  value={panelName}
              ...
              <div>
                <label htmlFor="panel-description" className="text-sm font-medium mb-2 block">Description</label>
                <Textarea
