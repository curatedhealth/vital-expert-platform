      ...
      <div className="flex-1 overflow-hidden flex flex-col">
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-sm border rounded-lg bg-background text-foreground focus:ring-2 focus:ring-primary focus:border-transparent"
                  >
                    ...
                    <button
                      ...
                      className={'p-4 rounded-lg border-2 text-left transition-all ' + 
                        currentMode.id === 3
                          ...
                          : 'border-border hover:border-purple-400 bg-card'
                      }
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-semibold text-foreground">
                    ...
                    <button
                      ...
                      className={'p-4 rounded-lg border-2 text-left transition-all ' + 
                        currentMode.id === 4
                          ...
                          : 'border-border hover:border-green-400 bg-card'
                      }
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-semibold text-foreground">
                ...
                <div className="p-3 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-primary">
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center py-12">
                ...
                {selectedAgents.length === 0 && (currentMode.id === 1 || currentMode.id === 4) && (
                  <div className="w-full max-w-md mt-6 p-4 bg-primary/10 rounded-lg border border-primary/30">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 sticky bottom-0">
          <PromptInput
            ...
            // Add new props for header buttons
