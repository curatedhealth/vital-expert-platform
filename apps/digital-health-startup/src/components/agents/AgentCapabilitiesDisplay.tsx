                      ...
                      >
                        <Collapsible>
                          <CollapsibleTrigger
                            ...
                            onClick={() => toggleCapabilityExpansion(capability.capability_id)}
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3 text-left">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Badge
                                      variant="secondary"
                                      className={cn("text-xs", proficiencyColors[capability.proficiency_level as keyof typeof proficiencyColors])}
                                    >
