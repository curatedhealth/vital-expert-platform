/**
 * Clean Panel Type Card Component
...
import type { PanelTypeInfo } from '@/types/panel.types';
...
export function PanelTypeCard({ panelType, onSelect, onLearnMore }: PanelTypeCardProps) {
