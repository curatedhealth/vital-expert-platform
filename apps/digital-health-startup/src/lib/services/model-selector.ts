...
export const AVAILABLE_EMBEDDING_MODELS = {
  ...
  // HuggingFace - Top Performers (2025 MTEB Leaders)
  'mxbai-embed-large-v1': {
    ...
    suitable_for: ['rag', 'general', 'multilingual', 'search'],
  },
  'e5-large-v2': {
    ...
    suitable_for: ['rag', 'retrieval', 'instruction-tuned'],
  },
  'bge-m3': {
    ...
    suitable_for: ['rag', 'multilingual', 'retrieval', 'rerank'],
  },
  'multilingual-e5-large': {
    ...
    suitable_for: ['multilingual', 'global', 'diverse-languages'],
  },
  'bge-small-en-v1.5': {
    ...
    suitable_for: ['lightweight', 'high-volume', 'edge', 'cost-efficient'],
  },
  'all-MiniLM-L6-v2': {
    ...
    suitable_for: ['ultra-fast', 'minimal-resources'],
  },
  'bge-base-en-v1.5': {
    name: 'BGE Base',
    provider: 'HuggingFace',
  ...
  'bge-large-en-v1.5': {
    ...
    suitable_for: ['high-quality', 'general'],
  },
  'gte-large': {
    ...
    suitable_for: ['long-documents', 'multi-paragraph', 'document-embedding'],
  },
  'all-mpnet-base-v2': {
    ...
    suitable_for: ['similarity', 'clustering', 'topic-modeling'],
  },

  // HuggingFace - Biomedical/Scientific (Specialized)
  'sapbert-pubmed': {
    ...
    suitable_for: ['biomedical', 'scientific', 'pubmed', 'clinical'],
  },
  'biobert-mnli': {
    ...
    suitable_for: ['biomedical', 'nli', 'similarity'],
  },
  'biobert-base': {
    name: 'BioBERT Base',
    provider: 'HuggingFace',
    ...
    suitable_for: ['biomedical', 'clinical'],
  },
  'biobert-pubmed': {
    name: 'BioBERT PubMed',
    provider: 'HuggingFace',
  ...
  'pubmedbert': {
    ...
    suitable_for: ['medical', 'scientific', 'pubmed'],
  },
  'pubmedbert-abstract': {
  ...
  'codebert-base': {
    ...
    suitable_for: ['code', 'technical', 'software'],
  },
} as const;
