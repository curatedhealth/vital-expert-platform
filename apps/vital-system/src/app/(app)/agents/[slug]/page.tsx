...
function AgentDetailContent() {
  ...
  const { addToComparison, comparisonAgents: comparisonAgentsRaw, removeFromComparison } = useAgentComparison();
                    ...
                    {relatedAgents.map((related) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() => router.push(`/agents/${(related as any).slug || related.id}`)}
                        >
                          <div
