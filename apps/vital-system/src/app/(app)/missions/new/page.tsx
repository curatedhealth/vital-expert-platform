        ...
        <div className="container max-w-5xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/ask-expert/missions" className="p-2 hover:bg-stone-100 rounded-lg transition-colors">
              ...
              <div>
                ...
                {missionId && <p className="text-sm text-stone-500">ID: {missionId}</p>}
              </div>
            </div>
            <div className="flex items-center gap-3">
              {isActive && <span className="text-sm text-stone-500">{Math.round(progress)}%</span>}
        ...
        <div className="grid gap-6">
          ...
          {isActive && (
            <>
              ...
              {objective && (
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <h3 className="text-sm font-medium text-stone-500 mb-2">Objective</h3>
                  <p className="text-stone-900">{objective}</p>
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    {selectedTeam.length > 0 && <span className="text-xs text-stone-500">Team: {selectedTeam.join(', ')}</span>}
                  </div>
                </div>
              )}
