...
export const GET = withAgentAuth(async (
  ...
  try {
    ...
    const personaWithData = {
      ...persona,
      slug: persona.unique_id || (persona as any).slug || slug,
      name: (persona as any).persona_name || (persona as any).name || slug,
      tagline: (persona as any).description || (persona as any).tagline,
      one_liner: (persona as any).description || (persona as any).one_liner,
      role_id: persona.source_role_id,
      role_slug: (persona as any).role_slug,
      department_name: (persona as any).department || (persona as any).department_name,
      function_name: (persona as any).function_area || (persona as any).function_name,
