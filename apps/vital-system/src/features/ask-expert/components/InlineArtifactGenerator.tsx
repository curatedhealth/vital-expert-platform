...
export function InlineArtifactGenerator({
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      logger.error('InlineArtifactGenerator failed to generate document', { error: generationError });
  ...
  const handleShare = useCallback(async () => {
    ...
    try {
      ...
      logger.error('InlineArtifactGenerator share failed', { error: shareError });
    }
  }, [generatedDoc]);
