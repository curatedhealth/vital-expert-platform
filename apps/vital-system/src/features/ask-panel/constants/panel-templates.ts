...
export const PANEL_TEMPLATES: PanelTemplate[] = [
  ...
  // ==========================================================================
  // PANEL WORKFLOW TEMPLATES (Designer-integrated)
  // ==========================================================================
  {
    id: 'structured_panel',
  ...
  },
  {
    ...
    icon: '❓',
    category: 'panel',
    tags: ['panel', 'socratic', 'questioning', 'debate'],
    popularity: 86,
  },
  {
    ...
    icon: '⚖️',
    category: 'panel',
    tags: ['panel', 'devils-advocate', 'risk', 'challenge'],
    popularity: 84,
  },
  {
    id: 'structured_ask_expert_panel',
    ...
    icon: '📌',
    category: 'panel',
    tags: ['ask-expert', 'structured', 'consultation'],
    popularity: 90,
  },
];
