...
export function AgentProfileHeader({
  ...
  return (
    <div className={`border-b px-6 py-3 bg-neutral-50 flex-shrink-0 ${className}`}>
      <div className="max-w-4xl mx-auto flex items-center gap-3">
        {/* Agent Avatar */}
        <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white border-2 border-neutral-200 overflow-hidden flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-neutral-600 truncate">{agent.description}</p>
        </div>
