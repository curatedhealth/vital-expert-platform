...
export const SERVICE_LAYERS = [
  {
    id: 'ask-expert',
    name: 'Ask Expert',
    description: 'Focused insight from a single domain expert — fast, precise, and grounded in experience.',
    timing: '<3 seconds',
    icon: 'Sparkles',
  },
  {
    id: 'expert-panel',
    name: 'Expert Panel',
    description: 'Multiple experts think together, challenge assumptions, and surface trade-offs.',
  ...
  },
  {
    ...
    description: 'Multi-step reasoning with checkpoints, evidence, and human judgment.',
  ...
  },
  {
    ...
    description: 'End-to-end orchestration for complex, cross-functional challenges.',
