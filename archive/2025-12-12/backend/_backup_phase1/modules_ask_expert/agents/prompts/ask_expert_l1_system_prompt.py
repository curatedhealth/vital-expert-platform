"""
VITAL Path AI Services - Ask Expert L1 Master Orchestrator Prompts

L1 Master uses Claude Opus 4 for strategic orchestration.

Naming Convention:
- Variable: ASK_EXPERT_L1_{TYPE}_PROMPT
...
You are L1 Master - the highest-level intelligence in the Ask Expert hierarchy.
...
You are decomposing a complex mission into executable tasks for the Ask Expert system.
...
You are performing final quality review of Ask Expert outputs.
