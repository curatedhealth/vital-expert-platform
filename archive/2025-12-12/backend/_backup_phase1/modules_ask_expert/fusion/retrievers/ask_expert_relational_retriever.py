...
class AskExpertRelationalRetriever:
    ...
    def __init__(
        ...
        logger.info("ask_expert_relational_retriever_initialized")
    ...
    async def retrieve(
        ...
        """
        logger.info(
            "ask_expert_relational_retriever_retrieve_started",
            tenant_id=tenant_id,
            top_k=top_k,
        )
        ...
        try:
            ...
            logger.info(
                "ask_expert_relational_retriever_retrieve_completed",
                tenant_id=tenant_id,
            ...
            logger.error(
                "ask_expert_relational_retriever_retrieve_failed",
                tenant_id=tenant_id,
                error=str(e),
            )
            return []
    ...
    async def _find_similar_queries(
        ...
        try:
            ...
            logger.error(
                "ask_expert_relational_retriever_similar_queries_failed",
                error=str(e),
            )
    ...
    async def _aggregate_agent_performance(
        ...
        try:
            ...
            logger.error(
                "ask_expert_relational_retriever_aggregate_failed",
                error=str(e),
            )
            return {}
    ...
    async def _get_top_performing_agents(
        ...
        try:
            ...
            logger.error(
                "ask_expert_relational_retriever_top_agents_failed",
                error=str(e),
            )
            return []
