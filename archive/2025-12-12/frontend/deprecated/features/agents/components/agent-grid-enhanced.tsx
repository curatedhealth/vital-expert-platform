 ...
 *
 * @deprecated December 2025 - Use AgentGrid with EnhancedAgentCard from @vital/ui
 *
 * This component uses the deprecated agent-card-enhanced.tsx.
 * For new features, use:
 * - AgentGrid from ./agent-grid.tsx (primary grid with agent-card.tsx)
 * - Or EnhancedAgentCard + AgentCardGrid from @vital/ui
 */
