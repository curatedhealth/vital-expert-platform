...
// Stub for deprecated agents module - file is deprecated, see header
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const AgentExecutor = { fromAgentAndTools: (..._args: any[]) => ({ invoke: async () => ({}) }) };
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const createOpenAIFunctionsAgent = async (..._args: any[]) => ({});
