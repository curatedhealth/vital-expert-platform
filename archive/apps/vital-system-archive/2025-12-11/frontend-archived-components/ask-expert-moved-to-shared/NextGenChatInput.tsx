...
export function NextGenChatInput({
  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      {/* Main Input Area */}
      <div className="relative bg-white border border-neutral-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent">
