...
function AppLayoutContent({
  ...
  // Priority: 1) Real user from auth, 2) User profile from database, 3) Dev fallback ONLY if neither exists
  // PRODUCTION READY: This will NEVER show "dev" user in production since NODE_ENV will be 'production'
  ...
  // Show different sidebar for ask-expert page
  ...
  return (
    <div className={cn(
      ...
      {/* Desktop Sidebar - Shadcn collapsible sidebar */}
