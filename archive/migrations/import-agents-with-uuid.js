...
// Function to process Medical Affairs agents with UUID generation
...
// Function to process Market Access agents with UUID generation
...
// Function to process Marketing agents with UUID generation
...
async function importAgentsWithUUID() {
  try {
    console.log('🚀 AGENT IMPORT WITH UUID GENERATION');
    console.log('======================================================================\n');
    ...
    console.log('\n🎉 AGENT IMPORT WITH UUID COMPLETE!');
    console.log('======================================================================');
