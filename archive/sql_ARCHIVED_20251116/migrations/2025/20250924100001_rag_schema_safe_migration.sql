-- VITAL Path Phase 1: Safe RAG System Migration (Handles Existing Schema)
...
-- Knowledge sources table for RAG system
CREATE TABLE IF NOT EXISTS rag_knowledge_sources (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID REFERENCES rag_tenants(id) ON DELETE CASCADE DEFAULT (
