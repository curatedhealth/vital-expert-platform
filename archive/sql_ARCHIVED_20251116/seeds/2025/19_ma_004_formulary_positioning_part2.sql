-- 19_ma_004_formulary_positioning_part2.sql
CREATE TEMP TABLE IF NOT EXISTS session_config (tenant_id UUID, tenant_slug TEXT);
DELETE FROM session_config; INSERT INTO session_config SELECT id, slug FROM tenants WHERE slug = 'digital-health-startup';
...
CROSS JOIN (VALUES ('TSK-MA-004-02','TSK-MA-004-01','Tier strategy requires landscape'),('TSK-MA-004-03','TSK-MA-004-02','Access aligns with tier'),
('TSK-MA-004-04','TSK-MA-004-03','UM follows access strategy'),('TSK-MA-004-05','TSK-MA-004-02','Messaging supports tier placement'))
...
CROSS JOIN (VALUES ('TSK-MA-004-01','AGT-LITERATURE-SEARCH','PRIMARY_EXECUTOR',1,true,2,'EXPONENTIAL_BACKOFF',false,'P21_MA_DIR','AFTER_EXECUTION','ESCALATE_TO_HUMAN','{}'::jsonb),
('TSK-MA-004-02','AGT-WORKFLOW-ORCHESTRATOR','PRIMARY_EXECUTOR',1,true,2,'EXPONENTIAL_BACKOFF',false,'P21_MA_DIR','AFTER_EXECUTION','ESCALATE_TO_HUMAN','{}'::jsonb),
('TSK-MA-004-03','AGT-WORKFLOW-ORCHESTRATOR','PRIMARY_EXECUTOR',1,true,2,'EXPONENTIAL_BACKOFF',false,'P21_MA_DIR','AFTER_EXECUTION','ESCALATE_TO_HUMAN','{}'::jsonb),
('TSK-MA-004-04','AGT-WORKFLOW-ORCHESTRATOR','PRIMARY_EXECUTOR',1,true,2,'EXPONENTIAL_BACKOFF',false,'P05_REGAFF','AFTER_EXECUTION','ESCALATE_TO_HUMAN','{}'::jsonb),
('TSK-MA-004-05','AGT-CLINICAL-REPORT-WRITER','PRIMARY_EXECUTOR',1,true,2,'EXPONENTIAL_BACKOFF',false,'P21_MA_DIR','AFTER_EXECUTION','ESCALATE_TO_HUMAN','{}'::jsonb))
...
CROSS JOIN (VALUES ('TSK-MA-004-01','P21_MA_DIR','APPROVE','AFTER_AGENT_RUNS',NULL,'{}'::jsonb),('TSK-MA-004-02','P21_MA_DIR','APPROVE','AFTER_AGENT_RUNS',NULL,'{}'::jsonb),
('TSK-MA-004-03','P21_MA_DIR','APPROVE','AFTER_AGENT_RUNS',NULL,'{}'::jsonb),('TSK-MA-004-04','P05_REGAFF','APPROVE','AFTER_AGENT_RUNS',NULL,'{}'::jsonb),
('TSK-MA-004-05','P21_MA_DIR','APPROVE','AFTER_AGENT_RUNS',NULL,'{}'::jsonb),('TSK-MA-004-05','P24_PAYER_REL','REVIEW','AFTER_AGENT_RUNS',NULL,'{}'::jsonb))
...
SELECT 'MA-004 Part 2 Complete' as status;
