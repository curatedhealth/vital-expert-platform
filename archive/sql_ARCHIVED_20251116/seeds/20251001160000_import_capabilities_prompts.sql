-- =====================================================================
-- Import Capabilities and Prompts from Batch Upload Files
-- =====================================================================
...
(
  ...
  '{"device_type": "string", "device_class": "enum", "indication": "string", "primary_endpoint": "string", "population": "string", "pathway": "enum", "study_design": "enum", "sample_size": "integer", "study_duration": "string", "special_requirements": "string"}',
  '{"protocol_title": "string", "protocol_synopsis": "string", "objectives": "array", "study_design": "object", "patient_population": "object", "endpoints": "object", "statistical_plan": "object", "safety_monitoring": "object", "regulatory_considerations": "object"}',
  '{"description": "Protocol passes regulatory review checklist", "metrics": ["Completeness score >95%", "Regulatory compliance verified", "Medical review approved"]}',
  '{"input_requirements": ["Device classification must be valid", "Primary endpoint must be clinically meaningful", "Sample size must be statistically justified"], "output_validation": ["Protocol must include all ICH-GCP required sections", "Statistical plan must be mathematically sound", "Safety monitoring plan must be comprehensive"]}',
...
(
  ...
  'expert',
  4000,
  '{"model": "gpt-4", "temperature": 0.2, "max_tokens": 4500}',
  '{"device_name": "string", "device_class": "enum", "intended_use": "string", "pathway": "enum", "predicate_device": "string", "submission_type": "enum", "special_controls": "string", "clinical_data_available": "boolean", "risk_class": "enum"}',
  '{"executive_summary": "string", "device_description": "object", "predicate_comparison": "object", "substantial_equivalence": "object", "risk_analysis": "object", "clinical_summary": "object", "labeling": "object"}',
  '{"description": "Submission meets regulatory acceptance criteria", "metrics": ["Regulatory completeness >98%", "Technical accuracy verified", "Compliance confirmed"]}',
  '{"input_requirements": ["Device classification must be accurate", "Predicate device must be legally marketed", "Intended use must be clearly defined"], "output_validation": ["Substantial equivalence argument must be sound", "Risk analysis must be comprehensive", "Clinical evidence must support claims"]}',
...
(
  ...
  'advanced',
  3800,
  '{"model": "gpt-4", "temperature": 0.4, "max_tokens": 4000}',
  '{"technology_name": "string", "indication": "string", "population": "string", "comparator": "string", "time_horizon": "string", "perspective": "enum", "analysis_type": "enum", "cost_categories": "array", "outcomes": "array", "budget_constraint": "number"}',
  '{"research_question": "string", "model_structure": "object", "cost_analysis": "object", "outcome_analysis": "object", "cost_effectiveness": "object", "sensitivity_analysis": "object", "budget_impact": "object", "value_proposition": "object"}',
  '{"description": "Analysis meets HTA methodological standards", "metrics": ["Methodological rigor >90%", "Data quality verified", "Payer relevance confirmed"]}',
  '{"input_requirements": ["Technology must be clearly defined", "Comparator must be current standard of care", "Population must be well-characterized"], "output_validation": ["Model structure must be appropriate", "Costs must be comprehensive and accurate", "Outcomes must be clinically meaningful"]}',
...
(
  ...
  'advanced',
  3900,
  '{"model": "gpt-4", "temperature": 0.3, "max_tokens": 4200}',
  '{"company_type": "enum", "device_types": "array", "markets": "array", "size": "enum", "current_status": "enum", "standards": "array", "certifications": "array", "risk_level": "enum", "timeline": "string", "special_requirements": "string"}',
  '{"gap_analysis": "object", "quality_manual": "object", "process_documentation": "object", "design_controls": "object", "risk_management": "object", "document_control": "object", "training_framework": "object", "audit_program": "object", "management_review": "object"}',
  '{"description": "QMS design meets certification requirements", "metrics": ["Standards compliance >95%", "Process effectiveness verified", "Audit readiness confirmed"]}',
  '{"input_requirements": ["Device types must be properly classified", "Regulatory markets must be specified", "Standards requirements must be clear"], "output_validation": ["All required processes must be documented", "Risk-based approach must be evident", "Procedures must be implementable"]}',
...
(
  ...
  3700,
  '{"model": "gpt-4", "temperature": 0.3, "max_tokens": 4000}',
  '{"study_type": "enum", "primary_endpoint": "string", "secondary_endpoints": "array", "population": "string", "sample_size": "integer", "analysis_sets": "array", "methods": "array", "alpha": "number", "missing_data": "enum", "subgroups": "array"}',
  '{"analysis_plan": "object", "data_quality": "object", "baseline_characteristics": "object", "primary_analysis": "object", "secondary_analyses": "object", "safety_analysis": "object", "subgroup_analyses": "object", "conclusions": "object"}',
  '{"description": "Analysis meets regulatory statistical standards", "metrics": ["Statistical validity >95%", "Regulatory compliance verified", "Clinical interpretability confirmed"]}',
  '{"input_requirements": ["Primary endpoint must be pre-specified", "Statistical methods must be appropriate", "Sample size must be adequate"], "output_validation": ["All analyses must be statistically sound", "Results must be clearly interpreted", "Limitations must be acknowledged"]}',
