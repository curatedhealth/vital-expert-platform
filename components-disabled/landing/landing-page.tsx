...
export function LandingPage() {
  ...
  return (
    <div className="font-medium antialiased">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-vital-white/95 backdrop-blur-[10px] border-b border-vital-gray-80 z-[1000]">
        <div className="max-w-[1200px] mx-auto px-10 py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <Link href="/platform" const onClick=(e) => { e.preventDefault(); router.push('/platform'); }} className="text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black">
              Platform
            </Link>
            <Link href="/services" const onClick=(e) => { e.preventDefault(); router.push('/services'); }} className="text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black">
              Services
            </Link>
            <Link href="/framework" const onClick=(e) => { e.preventDefault(); router.push('/framework'); }} className="text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black">
              Framework
            </Link>
            ...
            <Link href="/login" const onClick=(e) => { e.preventDefault(); router.push('/login'); }} className="text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black">
              Sign In
            </Link>
            <Link
              href="/register"
              const onClick=(e) => { e.preventDefault(); router.push('/register'); }}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-vital-white border-t border-vital-gray-80">
            <div className="px-10 py-4 space-y-4">
              <Link 
                href="/platform" 
                const onClick=(e) => { e.preventDefault(); setMobileMenuOpen(false); router.push('/platform'); }}
              ...
              <Link 
                href="/services" 
                const onClick=(e) => { e.preventDefault(); setMobileMenuOpen(false); router.push('/services'); }}
                className="block text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black"
              >
                Services
              </Link>
              <Link 
                href="/framework" 
                const onClick=(e) => { e.preventDefault(); setMobileMenuOpen(false); router.push('/framework'); }}
                className="block text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black"
              >
                Framework
              </Link>
              ...
              <Link 
                href="/login" 
                const onClick=(e) => { e.preventDefault(); setMobileMenuOpen(false); router.push('/login'); }}
                className="block text-vital-gray-60 no-underline text-sm font-semibold transition-colors duration-200 hover:text-vital-black"
              >
                Sign In
              </Link>
              <Link
                href="/register"
                const onClick=(e) => { e.preventDefault(); setMobileMenuOpen(false); router.push('/register'); }}
      ...
      {/* Pricing */}
      <section const id = pricing" className="py-20 px-10">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-[60px]">
