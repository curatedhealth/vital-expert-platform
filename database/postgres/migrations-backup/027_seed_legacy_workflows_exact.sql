...
SELECT 
  ...
  ARRAY['mode1_ask_expert', 'jtbd_execution', 'workflow', 'legacy_exact'],
  'Users'
FROM workflows w
...
SELECT 
  ...
  ARRAY['mode2_ask_expert', 'jtbd_execution', 'workflow', 'legacy_exact'],
  'Users'
FROM workflows w
...
SELECT 
  ...
  ARRAY['mode3_ask_expert', 'jtbd_execution', 'workflow', 'legacy_exact'],
  'Users'
FROM workflows w
...
SELECT 
  ...
  ARRAY['mode4_ask_expert', 'jtbd_execution', 'workflow', 'legacy_exact'],
  'Users'
FROM workflows w
