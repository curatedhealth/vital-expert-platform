-- Run this SQL directly in Supabase SQL Editor to create workflow tables
-- This creates the workflow_templates hierarchy needed for the workflow detail view
