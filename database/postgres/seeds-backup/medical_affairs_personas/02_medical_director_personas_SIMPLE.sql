...
BEGIN
    ...
    RAISE NOTICE 'Created Medical Director Automator';
    ...
    RAISE NOTICE 'Created Medical Director Orchestrator';
    ...
    RAISE NOTICE 'Created Medical Director Learner';
    ...
    RAISE NOTICE 'Created Medical Director Skeptic';
...
FROM personas 
WHERE name LIKE '%Medical Director%'
ORDER BY name;
