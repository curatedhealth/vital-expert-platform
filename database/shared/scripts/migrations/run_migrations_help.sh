...
if [ ! -z "$SUPABASE_URL" ]; then
    ...
    echo "📋 Your Supabase Project: $SUPABASE_PROJECT_ID"
    echo "🔗 SQL Editor: https://supabase.com/dashboard/project/$SUPABASE_PROJECT_ID/sql/new"
else
    echo "⚠️  Could not find SUPABASE_URL in .env.local"
...
echo "   - Open: database/postgres/migrations/20251126_system_prompt_infrastructure.sql"
echo "   - Copy entire file"
echo "   - Paste in SQL Editor and click 'Run'"
echo ""
echo "3. Run Seed Data:"
echo "   - Open: database/postgres/seeds/20251126_system_prompt_seed_data.sql"
echo "   - Copy entire file"
echo "   - Paste in SQL Editor and click 'Run'"
echo ""
