-- Fix agents table structure and policies
-- This migration ensures all required columns exist before creating policies

-- =============================================
-- ENSURE AGENTS TABLE HAS ALL REQUIRED COLUMNS
-- =============================================

-- Add missing columns to agents table (force add if they don't exist)
...
-- Clear existing agents and insert the core 21 agents
