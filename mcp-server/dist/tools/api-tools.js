...
export class APITools {
    ...
    parseNextJSAPIFile(content, filePath) {
        const endpoints = [];
    ...
    parsePythonAPIFile(content, filePath) {
        const endpoints = [];
    ...
    extractPythonDescription(content, decorator) {
    ...
    extractPythonParameters(content) {
        const parameters = [];
    ...
    extractPythonResponseType(content) {
    ...
    async listEndpoints(method, path, service) {
    ...
    async getRequestSchema(endpointId) {
    ...
    async getResponseSchema(endpointId) {
        const endpoint = await this.getEndpointDetails(endpointId);
        return {
            endpointId: endpoint.id,
            method: endpoint.method,
