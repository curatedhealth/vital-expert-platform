...
// ============================================================================
// SKELETON SHIMMER (different from VitalShimmer text effect)
// ============================================================================
...
/**
 * VitalSkeletonShimmer - Skeleton placeholder with shimmer animation
 * 
 * NOTE: This is different from VitalShimmer (text shimmer effect).
 * This component creates a skeleton placeholder with a sweeping shimmer.
 * Use VitalShimmer for text loading indicators.
 */
export function VitalSkeletonShimmer({ className }: SkeletonShimmerProps) {
  return (
    <div className={cn(
...
export default {
  ...
  SkeletonShimmer: VitalSkeletonShimmer,
