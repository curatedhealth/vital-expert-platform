...
def check_dependencies():
    ...
    try:
        ...
        print("❌ datamodel-code-generator is not installed")
...
def generate_pydantic(schema_name: str) -> bool:
    ...
    if not input_file.exists():
        print(f"  ⚠️  Skipping {schema_name}: JSON Schema not found at {input_file}")
    ...
    if result.returncode != 0:
        print(f"  ❌ Failed to generate {schema_name}:")
...
def generate_extensions_stub():
    ...
    if extensions_file.exists():
        print(f"  ℹ️  extensions.py already exists, skipping")
        return
...
'''
    ...
    print(f"  ✅ extensions.py (stub created)")
...
def main():
    ...
    if not PROTOCOL_JSON_SCHEMAS.exists():
        print(f"❌ JSON Schemas directory not found: {PROTOCOL_JSON_SCHEMAS}")
    ...
    print()
    print("✨ Pydantic model generation complete!")
