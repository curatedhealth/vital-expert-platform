#!/usr/bin/env python3
"""
Import SP06 Talent Development Operational Library to Supabase
===============================================================

Imports:
- 8 JTBDs with enhanced metadata
- 8 complete workflows with phases and tasks
    ...
    try:
        ...
        workflow_data = {
            ...
            'definition': {
                ...
                'phases': phases_data,
                'source': 'SP06 Operational Library',
                'strategic_pillar': 'SP06',
                'pillar_name': 'Talent Development',
...
def main():
    ...
    print("╔════════════════════════════════════════════════════════════╗")
    print("║  Import SP06 Talent Development Library                   ║")
    print("║  8 JTBDs + 8 Workflows with Phases & Tasks                ║")
    print("╚════════════════════════════════════════════════════════════╝\n")
    
    # Load JSON file
    json_file = '/Users/hichamnaim/Downloads/SP06_TalentDevelopment_OperationalLibrary_FULL.json'
    ...
    try:
        ...
        print(f"\n🎯 Strategic Pillar: SP06 - Talent Development")
