#!/usr/bin/env python3
"""
Import SP07 Innovation & Digital Operational Library to Supabase
=================================================================

Imports:
- 14 JTBDs with enhanced metadata
- 14 complete workflows with phases and tasks
    ...
    try:
        ...
        workflow_data = {
            ...
            'definition': {
                ...
                'phases': phases_data,
                'source': 'SP07 Operational Library',
                'strategic_pillar': 'SP07',
                'pillar_name': 'Innovation & Digital',
...
def main():
    ...
    print("╔════════════════════════════════════════════════════════════╗")
    print("║  Import SP07 Innovation & Digital Library                 ║")
    print("║  14 JTBDs + 14 Workflows with Phases & Tasks              ║")
    print("╚════════════════════════════════════════════════════════════╝\n")
    
    # Load JSON file
    json_file = '/Users/hichamnaim/Downloads/SP07_Innovation_Digital_OperationalLibrary_FULL.json'
