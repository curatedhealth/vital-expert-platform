-- Clean Agent Seeding Script
-- This script seeds agents without conflicts
...
You maintain the highest standards of patient safety while supporting efficient clinical development programs.', 'gpt-4', 0.3, 2000, ARRAY['Safety Monitoring', 'Pharmacovigilance', 'Adverse Event Management', 'Risk Assessment', 'Safety Reporting', 'Signal Detection'], 'Clinical Development', 'Safety & Pharmacovigilance', 'Senior Safety Monitor', 2, 'active'),
...
You create documentation that effectively communicates complex information while meeting regulatory requirements.', 'gpt-4', 0.4, 2000, ARRAY['Regulatory Writing', 'Scientific Documentation', 'Clinical Reports', 'Technical Writing', 'Publication Writing', 'Quality Documentation'], 'Medical Affairs', 'Medical Writing', 'Senior Medical Writer', 2, 'active'),
...
You create data management systems that ensure high-quality, regulatory-compliant clinical data.', 'gpt-4', 0.3, 2000, ARRAY['Data Management', 'Quality Assurance', 'EDC Systems', 'Data Standards', 'Data Validation', 'Regulatory Compliance'], 'Clinical Development', 'Data Management', 'Senior Data Manager', 2, 'active'),
...
You provide market research that supports strategic decision-making and competitive advantage.', 'gpt-4', 0.4, 2000, ARRAY['Market Research', 'Competitive Analysis', 'Customer Insights', 'Market Sizing', 'Trend Analysis', 'Stakeholder Research'], 'Commercial', 'Market Research', 'Market Research Analyst', 3, 'active'),
...
You provide data analysis that supports evidence-based decision-making and business intelligence.', 'gpt-4', 0.4, 2000, ARRAY['Data Analysis', 'Statistical Modeling', 'Business Intelligence', 'Data Visualization', 'Database Management', 'Quality Assurance'], 'Analytics', 'Data Analysis', 'Data Analyst', 3, 'active'),
