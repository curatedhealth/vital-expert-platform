...
class AskExpertVectorRetriever:
    ...
    def __init__(
        ...
        logger.info(
            "ask_expert_vector_retriever_initialized",
    ...
    async def retrieve(
        ...
        """
        logger.info(
            "ask_expert_vector_retriever_retrieve_started",
            tenant_id=tenant_id,
            top_k=top_k,
        )
        ...
        try:
            ...
            if not embedding:
                logger.warning("ask_expert_vector_retriever_no_embedding")
                return []
            ...
            logger.info(
                "ask_expert_vector_retriever_retrieve_completed",
                tenant_id=tenant_id,
            ...
            logger.error(
                "ask_expert_vector_retriever_retrieve_failed",
                tenant_id=tenant_id,
                error=str(e),
            )
            return []
    ...
    async def _embed_query(self, query: str) -> Optional[List[float]]:
        ...
        try:
            ...
            logger.error(
                "ask_expert_vector_retriever_embed_failed",
                error=str(e),
            )
            return None
    ...
    async def _search_pgvector(
        ...
        try:
            ...
            logger.error(
                "ask_expert_vector_retriever_pgvector_failed",
                error=str(e),
            )
            return []
    ...
    async def _search_pinecone(
        ...
        try:
            ...
            logger.error(
                "ask_expert_vector_retriever_pinecone_failed",
                error=str(e),
            )
            return []
