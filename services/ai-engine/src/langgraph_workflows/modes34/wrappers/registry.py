...
# MODES_SUPPORTED: [3, 4]
# DEPENDENCIES: [agents.experts, agents.specialists, agents.workers]
"""
...
L2_MAP: Dict[str, str] = {
    "regulatory": "agents.experts.l2_regulatory_expert.L2RegulatoryExpert",
    "clinical": "agents.experts.l2_clinical_expert.L2ClinicalExpert",
    "safety": "agents.experts.l2_safety_expert.L2SafetyExpert",
    "domain_lead": "agents.experts.l2_domain_lead.L2DomainLead",
}

L3_MAP: Dict[str, str] = {
    "context_specialist": "agents.specialists.l3_context_specialist.L3ContextSpecialist",
    "task_specialist": "agents.specialists.l3_task_specialist.L3TaskSpecialist",
}

L4_MAP: Dict[str, str] = {
    "evidence": "agents.workers.l4_evidence.L4EvidenceSynthesizer",
}
