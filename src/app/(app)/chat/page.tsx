                        ...
                        <div className="flex flex-col items-center justify-center h-full px-6">
                          <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600 mb-4 max-w-md">
                              Select an AI agent from the sidebar to start a conversation, or choose a prompt below.
                            </p>
                          </div>
                          <div className="w-full max-w-4xl">
                            ...
                            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                              {promptStarters.map((prompt, index) => (
                                <Card
                                  key={index}
                                  className="group p-4 cursor-pointer hover:shadow-lg transition-all duration-200 hover:border-blue-300 border-gray-200 bg-white hover:-translate-y-0.5"
                                  onClick={() => {
                                    if (!autoAgentSelection && !selectedAgent && agents.length > 0) {
                                      setSelectedAgent(agents[0]);
                                    }
                                  ...
                                  <div className="flex items-start gap-3">
                                    <div className={cn(
                                      ...
                                      {getPromptIcon(prompt.text).startsWith('http') || getPromptIcon(prompt.text).startsWith('/') ? (
                                        ...
                                        <span className="text-sm">{getPromptIcon(prompt.text)}</span>
                                      )}
                                    </div>
                                    <div>
                                      <h4 className="font-semibold text-gray-900 mb-1 text-sm">{prompt.text}</h4>
