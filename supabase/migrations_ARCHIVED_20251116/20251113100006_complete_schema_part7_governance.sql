...
-- SKIPPED: Old llm_usage_logs table has different columns than gold standard
-- Indexes can be added later after schema alignment
DO $$
BEGIN
  RAISE NOTICE 'Skipping llm_usage_logs indexes - old schema differs from gold standard';
END $$;
