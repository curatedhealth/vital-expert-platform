-- ============================================================================
-- UNIFIED PROMPTS™ SCHEMA - Single Source of Truth (FINAL FIXED VERSION)
-- ============================================================================
...
DROP POLICY IF EXISTS "Allow all authenticated users to insert prompts" ON prompts;
DROP POLICY IF EXISTS "Allow all authenticated users to update prompts" ON prompts;
DROP POLICY IF EXISTS "Allow all authenticated users to view prompt suites" ON prompt_suites;
DROP POLICY IF EXISTS "Allow authenticated users to manage prompt suites" ON prompt_suites;
...
CREATE POLICY "Allow all authenticated users to insert prompts"
  ON prompts FOR INSERT
  TO authenticated
  WITH CHECK (true);

CREATE POLICY "Allow all authenticated users to update prompts"
  ON prompts FOR UPDATE
  TO authenticated
  USING (true);

-- Create policies for prompt_suites
CREATE POLICY "Allow all authenticated users to view prompt suites"
  ON prompt_suites FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Allow authenticated users to manage prompt suites"
